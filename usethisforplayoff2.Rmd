...
nba_api <- read_csv("/Users/blakefuquay/Downloads/2019to2024nbagamestats.csv") 
...
TotalPointsModel <- lm(TotalPts ~ TEAM_NAME + opposition + Pace + Possessions + Avg_Shooting_Percentage + FGA + FTA + FG3A + FG3M + FGA*FTA + FGA*FGM +FGM + ORtg + DRtg, data = game_stats)
...
```{r}
library(readr)
combined <- read_csv("/Users/blakefuquay/Downloads/injuries.csv")
