...
```{r}
OREBmodel <- lm(OREB ~ sqrt(DREB) + average_treb + Possessions + Avg_Shooting_Percentage + FTA + FG_PCT + FGM + TEAM_NAME + opposition + Pace + FTA*FGA + FGA*FGM, data = game_stats)
summary(OREBmodel)
```
...
TotalPointsModel <- lm(TotalPts ~ TEAM_NAME + opposition + Pace + Possessions + Avg_Shooting_Percentage + FGA + FTA + FG3M + FGA*FTA + FGA*FGM +FGM + ORtg + DRtg, data = game_stats)
